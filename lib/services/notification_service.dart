  ...
  static redirectNotification(Map<String, dynamic> message) async {
    if (message.containsKey("board_id")) {
      if (message['isImage'] == "1") {
        ...
        await boardsController
            .init(PrefService.getString(PrefKeys.languageCode));
        ...
        if (treeData != null) {
          await boardsController.onTapFolder(
            ...
            treeData.name,
            (treeData.id.toString() == "0" && treeData.name == '')
                ? treeData.icon
                : treeData.icon,
            ...
            mainCategory: (treeData.id.toString() == "0" && treeData.name == '')
                ? treeData.name
                : treeData.name,
          );
        }
